...
# echo -e "Hint, yours are in: users_Folder/ops/docker_prov on the nas... \n"
# echo "rsync -zPvh admin@${NAS_IP}:/volume1/users_Folder/ops/docker_prov/au491.nordvpn.com.tcp443.ovpn /home/user/docker/qbittorrent/openvpn/"
# echo "rsync -zPvh admin@${NAS_IP}:/volume1/users_Folder/ops/docker_prov/credentials.conf /home/user/docker/qbittorrent/openvpn/"
